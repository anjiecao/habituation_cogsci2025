...
```{r}
cor(measure_cor_adults$log_hab_dev_diff, measure_cor_adults$resid_dev, use = "complete.obs")
cor(measure_cor_preschoolers$log_hab_dev_diff, measure_cor_preschoolers$resid_dev, use = "complete.obs")
cor(measure_cor_infants$log_hab_dev_diff, measure_cor_infants$resid_dev,use = "complete.obs")
```
