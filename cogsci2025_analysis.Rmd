...
all_hab <- bind_rows(
  ...
  theme_classic() + 
  facet_wrap(~group, scales = "free", nrow = 3) + theme( strip.background = element_blank(), axis.text=element_text(size=12), 
...
all_dishab <- bind_rows(
  ...
  geom_boxplot(width = 0.5, color = "maroon3", outlier.alpha = 0.5, alpha = .4) +
