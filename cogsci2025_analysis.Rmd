...
correlation_matrix <- cor(adult_cor_df, use = "complete.obs")
p_value_matrix <- rcorr(as.matrix(adult_cor_df))$P
...
correlation_matrix <- cor(preschooler_cor_df, use = "complete.obs")
p_value_matrix <- rcorr(as.matrix(preschooler_cor_df))$P
p_value_matrix[is.na(p_value_matrix)] <- 1
...
correlation_matrix <- cor(infant_cor_df, use = "complete.obs")
p_value_matrix <- rcorr(as.matrix(infant_cor_df))$P
p_value_matrix[is.na(p_value_matrix)] <- 1
